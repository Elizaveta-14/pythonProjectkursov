import pandas as pd
from src.utils import (hello_person, get_mask_account,
                       get_convert_amount, analyze_transactions,stock_prices)


def generate_main_page(data: pd.DataFrame, currency_code: str, amount: float,
                       transaction_content: int) -> dict:
